""" One-off Script
Used to verify a bug at a url

python3 verify.py /usl/to/test.html
"""

import sys

from lqc.selenium_harness import webdrivers
from lqc.selenium_harness.layout_tester import run_test_on_page, run_test_using_js_diff_detect
...
if __name__ == "__main__":
    ...
    chrome_webdriver = webdrivers.chrome.getWebDriver(window_width=500, window_height=500, headless=True)
    # width = 1024
    # height = 994
    ...
    # firefox_webdriver = webdriver.firefox.getWebDriver()
